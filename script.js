var game = new Phaser.Game(800, "100%", Phaser.AUTO, '', {preload: preload, create: create, update: update});
...
function preload() {
    ...
    game.load.spritesheet('button', 'img/button.png', 160, 60);
}
function create() {
...
function update() {
    ...
    else if (paddle.x > game.width - 38)
    {
        paddle.x = game.width - 38;
    }
}
function initBricks() {
    brickInfo = {
